...
export default function ConfirmDialog({
  ...
  return (
    <div className="modal-overlay" onClick={onCancel} style={{ zIndex: 600 }}>
      <div
      ...
      >
        ...
        <div className="mt-6 flex items-center justify-end gap-2.5">
          <button
            onClick={onCancel}
            className="btn btn-default px-4 py-[7px] text-[12.5px] font-medium"
          >
            {cancelText}
          </button>
          <button
            onClick={onConfirm}
            autoFocus
            className="btn btn-danger px-4 py-[7px] text-[12.5px] font-semibold"
          >
            {confirmText}
          </button>
        </div>
