...
import {
  NotebookPen, Link, Lightbulb, BookOpen, Baby, KeyRound, Wrench, CalendarDays, CalendarClock, Bot, Newspaper, UserRound, Book,
} from 'lucide-react';
...
const TOOL_META = {
  ...
  '/deploy-guide': {
    label: '部署指南', sub: '架构·部署·排障完整参考文档', Icon: Book, accent: '#3B5BFF',
  },
};
